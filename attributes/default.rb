...
default['php-fpm']['pool']['default_pool']['listener_owner'] = user
default['php-fpm']['pool']['default_pool']['listener_group'] = group
default['php-fpm']['pool']['default_pool']['listener_mode'] = "0666"
